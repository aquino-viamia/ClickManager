...
<div class="intro-y box px-5 pt-5 mt-5">
    ...
    <div class="mt-4">
        <form class="grid grid-cols-12 mt-1"> 
            <input disabled type="text" class="form-control col-span-6" placeholder="Felipe da Silva Aquino">
            <input disabled type="text" class="form-control col-span-4" placeholder="Aquino">
            <input disabled type="text" class="form-control col-span-2" placeholder="161.088.377-21">
            ...
            <input disabled type="text" class="form-control col-span-4" placeholder="(21) 0000-0000">
            </div>
            ...
            <div class="mt-3 col-span-2 px-3">
                ...
                <input disabled type="text" class="form-control col-span-4" placeholder="(21) 98272-1520">
            </div>

            <div class="mt-3 col-span-3 px-3">
                <label class="form-label w-full flex flex-col sm:flex-row">E-mail</label> 
                <input disabled type="email" class="form-control col-span-4" placeholder="contato@felipeaquino.eti.br">
            </div>

            <div class="mt-3 col-span-3">
                <label class="form-label w-full flex flex-col sm:flex-row">Endereço</label> 
                <input disabled type="email" class="form-control col-span-6" placeholder="Endereço Completo">
            </div>
            <div class="mt-3 col-span-1 px-2">
                <label class="form-label w-full flex flex-col sm:flex-row">Número</label> 
                <input disabled type="email" class="form-control" placeholder="Nun">
            </div>
            <div class="mt-3 col-span-2">
                <label class="form-label w-full flex flex-col sm:flex-row">Complemento</label> 
                <input disabled type="email" class="form-control" placeholder="Completo">
            </div>
            <div class="mt-3 col-span-2 px-2">
                <label class="form-label w-full flex flex-col sm:flex-row">Bairro</label> 
                <input disabled type="email" class="form-control" placeholder="Bairro">
            </div>
            <div class="mt-3 col-span-2">
